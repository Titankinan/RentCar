...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2021 at 10:01 AM
...
INSERT INTO `customer` (`no_ktp`, `nama`, `email`, `username`, `password`) VALUES
('1301180283', 'Titan', 'tit@gmail.com', 'Titan', 'kinan'),
('1301180076', 'Rajih', 'jih@gmail.com', 'rajih', 'antimage'),
('1301184032', 'Riski', 'paad@gmail.com', 'Amardito', 'vespamerahku'),
('1301180351', 'Cheza', 'Ahmad@gmail.com', 'Yahya', 'Aamiin');
...
INSERT INTO `mobil` (`id_mobil`, `no_ktp_pemilik`, `nama_mobil`, `harga`, `warna`, `plat_nomor`, `deskripsi`, `status`) VALUES
(2, '222', 'brio b', 400, 'hitam', 'D 11 TES', 'mogok euy', '0'),
(3, '333', 'brio b', 400, 'bening', 'D111AAD', 'boros bensin', '1');
